...
import com.example.d_lyt.networksync.RegisterRequest;
...
//        image=findViewById(R.id.profilepic);
        ...
        loginuser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Register.this, com.example.d_lyt.LoginActivity.class));
                finish();
            }
        });
...
//        });
    ...
    private void sendRegistrationEmail(final String name, final String emails) {
                ...
                BackgroundMail.newBuilder(Register.this)
                        ...
                        .withUsername("kipngetich310@gmail.com")
